...
class TextToSpeechRedone {
    ...
    getInfo() {
        return {
            ...
            blocks: [{
                    ...
                    text: 'this extension is powered by TTS Tool',
                },
                {
                    blockType: Scratch.BlockType.LABEL,
                    text: 'thanks a LOT!!',
                ...
                },
                {
                    ...
                    blockType: Scratch.BlockType.COMMAND,
                    text: 'play generated TTS with pitch [PITCH] panning [PANNING] volume [VOLUME]',
                    arguments: {
                        PITCH: {
    ...
    generateTTS(args) {
        let selectedVoice;
        try {
            selectedVoice = JSON.parse(args.VOICE);
    ...
    playGeneratedTTS(args) {
        ...
        fetch(this.audioUrl)
            ...
            .then(decodedData => {
                ...
                source.playbackRate.value = args.PITCH;
                gainNode.gain.value = args.VOLUME;
                panNode.pan.value = args.PANNING;
    ...
    isApiUp() {
        return Scratch.fetch('https://support.readaloud.app/read-aloud/list-voices/premium')
            .then(response => {
                if (response.ok) {
                    return true;
                }
