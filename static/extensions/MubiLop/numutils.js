  ...
  class MubiLopNumberUtilities {
    ...
    toLocaleString(args) {
      try {
        ...
        return Cast.toNumber(args.NUMBER).toLocaleString(this.systemLocale); // jwklong asked for this
      }
    }
    ...
    formatCurrency(args) {
      try {
        ...
        return Cast.toNumber(args.NUMBER).toLocaleString('en-US', {
          style: 'currency',
          currency: "USD" // im not gonna do a ton of things just for the currency based on locale
        });
      }
    }
