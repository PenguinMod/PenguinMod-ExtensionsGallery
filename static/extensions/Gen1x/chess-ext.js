    ...
    class ChessExtension {
        ...
        async initializeBoard() {
            try {
                ...
                let inFullscreen = checkInFullscreen();
                ReduxStore.subscribe(() => {
                    const currentlyInFullscreen = checkInFullscreen();
                    if (inFullscreen !== currentlyInFullscreen) {
                        inFullscreen = currentlyInFullscreen;
        ...
        setCustomBoardSize({
            ...
            this.settings.customSize = Math.max(100, Math.min(SIZE, Scratch.vm.runtime.stageHeight));
            this._updateBoardSize();
        }
