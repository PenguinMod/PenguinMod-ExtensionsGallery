...
class LightExtension {
  constructor() {
    ...
    this.canvas.style.cssText =
      'position:absolute;top:0;left:0;width:100%;height:100%;pointer-events:none;z-index:0;mix-blend-mode:multiply;display:block;clip-path:inset(0 round inherit);';
  ...
  async openRenderSettings() {
    ...
    if (!ScratchBlocks || !ScratchBlocks.customPrompt) {
      ...
      if (amb) { this.ambient = amb; this._ambientRGB = this.hexToRgb(amb); }
    ...
    container.style.cssText = 'display:flex;flex-direction:column;gap:16px;padding:8px 0 16px;font-family:sans-serif;';
  ...
  _loadRenderSettings() {
    ...
    try {
      ...
      if (typeof s.ambient        === 'string') { this.ambient = s.ambient; this._ambientRGB = this.hexToRgb(s.ambient); }
  ...
  deserialize(data) {
    if (isPenguinMod && data) {
      ...
      if (typeof data.ambient        === 'string') { this.ambient = data.ambient; this._ambientRGB = this.hexToRgb(data.ambient); }
      ...
      try {
        ...
        this._worker.onmessage = ({ data: msg }) => {
          if (msg.type === 'ready') {
            ...
            this._displayCtx.clearRect(0, 0, bmp.width, bmp.height);
            this._displayCtx.drawImage(bmp, 0, 0);
            bmp.close();
        ...
        this._worker.postMessage({ type: 'init', w, h });
        return;
  ...
  _render() {
    ...
    const pw  = Math.max(1, Math.round(w * dpr * pixScale));
    const ph  = Math.max(1, Math.round(h * dpr * pixScale));
    ...
    const gl = this._gl;
    const { prog, vao, u, ubo } = this._glState;
  ...
  settingGet(args) {
    ...
    switch (key) {
      case 'shadowOpacity':  return this.shadowOpacity;
      case 'ambient':        return this.ambient;
      case 'bloomAmount':    return this.bloomAmount;
      case 'bloomRadius':    return this.bloomRadius;
      case 'bloomThreshold': return this.bloomThreshold;
  ...
  getInfo() {
    return {
      ...
      blocks: [
        ...
        { blockType: Scratch.BlockType.LABEL, text: 'Engine' },
        { opcode: 'glSupported', blockType: Scratch.BlockType.BOOLEAN,  text: 'browser supports lighting engine?' },
        { opcode: 'renderMode',  blockType: Scratch.BlockType.REPORTER, text: 'render mode' },
        {
          opcode: 'toggleLight',
        ...
        '---',
        '---',
        { blockType: Scratch.BlockType.LABEL, text: 'Ambient & Shadow' },
        {
          opcode: 'setAmbient',
          blockType: Scratch.BlockType.COMMAND,
        ...
        },
        {
          ...
          arguments: { OPACITY: { type: Scratch.ArgumentType.NUMBER, defaultValue: 85 } }
        },
        '---',
        { blockType: Scratch.BlockType.LABEL, text: 'Create Lights' },
        {
          ...
          arguments: {
            ...
            RADIUS: { type: Scratch.ArgumentType.NUMBER, defaultValue: 150 },
        ...
        },
        {
          ...
          arguments: {
            ...
            COLOR:    { type: Scratch.ArgumentType.COLOR,  defaultValue: '#ffffff' },
            SOFTNESS: { type: Scratch.ArgumentType.NUMBER, defaultValue: 40 }
          }
        },
        '---',
        { blockType: Scratch.BlockType.LABEL, text: 'Modify Lights' },
        {
          opcode: 'setLightProp',
          blockType: Scratch.BlockType.COMMAND,
        ...
        },
        {
          ...
          arguments: {
            PROP: { type: Scratch.ArgumentType.STRING, menu: 'propMenu' },
            ID:   { type: Scratch.ArgumentType.STRING, defaultValue: 'light1' },
            VAL:  { type: Scratch.ArgumentType.NUMBER, defaultValue: 10 }
          }
        },
        {
          opcode: 'setLightXY',
        ...
        '---',
        { blockType: Scratch.BlockType.LABEL, text: 'Read Lights' },
        {
          opcode: 'getLightProp',
          ...
          arguments: {
            ID:   { type: Scratch.ArgumentType.STRING, defaultValue: 'light1' },
            PROP: { type: Scratch.ArgumentType.STRING, menu: 'propMenuFull' }
          }
        },
        {
          opcode: 'lightExists',
        ...
        '---',
        { blockType: Scratch.BlockType.LABEL, text: 'Manage' },
        {
          opcode: 'deleteLight',
          blockType: Scratch.BlockType.COMMAND,
        ...
        { opcode: 'clearLights', blockType: Scratch.BlockType.COMMAND, text: 'clear all lights' },
        '---',
        ...(isTurboWarp ? [{ blockType: Scratch.BlockType.LABEL, text: 'Render Settings' }] : []),
        {
          opcode:          'settingSetShadowOpacity',
          blockType:       Scratch.BlockType.COMMAND,
          hideFromPalette: isPenguinMod,
          text:            'set shadow opacity to [OPACITY]',
          arguments:       { OPACITY: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0.85 } }
        },
        {
        ...
        ...(isTurboWarp ? [{ blockType: Scratch.BlockType.LABEL, text: 'Bloom' }] : []),
        {
          opcode:          'settingSetBloomAmount',
          blockType:       Scratch.BlockType.COMMAND,
          hideFromPalette: isPenguinMod,
          text:            'set bloom amount to [VALUE]',
          arguments:       { VALUE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 1.0 } }
        },
        {
          ...
          arguments:       { VALUE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 0.32 } }
        },
        {
        ...
        ...(isTurboWarp ? [{ blockType: Scratch.BlockType.LABEL, text: 'Pixelation' }] : []),
        {
        ...
        },
        {
          ...
          arguments:       { SIZE: { type: Scratch.ArgumentType.NUMBER, defaultValue: 4 } }
        },
        ...(isTurboWarp ? [{ blockType: Scratch.BlockType.LABEL, text: 'Post Processing' }] : []),
        {
        ...
        '---',
        {
          ...
          arguments:       { SETTING: { type: Scratch.ArgumentType.STRING, menu: 'settingMenu' } }
        },
        {
      ...
      menus: {
        stateMenu:    { acceptReporters: false, items: ['show', 'hide'] },
        propMenu:     { acceptReporters: false, items: ['x', 'y', 'radius', 'width', 'height', 'direction', 'arc', 'softness'] },
        propMenuFull: { acceptReporters: false, items: ['x', 'y', 'radius', 'width', 'height', 'direction', 'arc', 'softness', 'color', 'type'] },
  ...
  glSupported() { return this._mode !== 'none'; }
  renderMode()  { return this._mode; }
  ...
  createPointLight(args) {
    ...
    const li = {
      ...
      radius: +args.RADIUS,
      width: 0, height: 0, direction: 0, arc: 360, softness: 0
    };
